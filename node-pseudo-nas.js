...
const server = http.createServer(function(request, response) {
    ...
    if (currentDir === undefined) { // error processing path; 404 file not found
        ...
        fs.lstat(fullFilePath, function(err, stats) {
            ...
            let end = parseInt(positions[1], 10) || total - 1;
